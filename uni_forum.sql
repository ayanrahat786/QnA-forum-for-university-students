...
(8, 'AMU', 'Univercity related problems', '2020-06-20 10:48:50'),
...
CREATE TABLE `uni_forum`.`profiles` 
('user_name' VARCHAR(12)NOT NULL,`name` VARCHAR(12) NOT NULL , `email` VARCHAR(12) NOT NULL , `contact` INT(10) NOT NULL, 'dt' TIMESTAMP)
 ENGINE = InnoDB;
--
...
(1, 'admin', '$2y$10$xKAkpcf2XlaG6DAo6dQ7beWMhB9g2ixKlR6SW6G.d754rARecLvuO', '2020-06-19 12:11:30');
