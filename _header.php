...
<a class="navbar-brand" href="./"><img src="https://www.amucontrollerexams.com/images/logo_nav.png" class="mx-2" width="40px" height="40px"><b>AMUDiscuss</b></a>
...
<div class="collapse navbar-collapse" id="navbarSupportedContent">
  <ul class="navbar-nav mr-auto">
    <li class="nav-item ">
      <a class="nav-link" href="./"><i class="fa fa-home mr-2" aria-hidden="true"></i><b>Home</b> <span class="sr-only">(current)</span></a>
    </li>
    <li class="nav-item">
  ...
  echo '</ul>
   ...
   <button class="btn btn-outline-light my-2 my-sm-0" type="submit"><i class="fa  fa-search mr-1" aria-hidden="true"></i>Search</button>
     ...
     <a href="partial/logout.php" class="btn btn-outline-success mx-2">Logout</a>
    </form>';
    }
   else{
    echo '<form class="form-inline my-2 my-lg-0" action="search.php" method="GET" >
