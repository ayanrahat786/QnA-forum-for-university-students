...
<body>
    ...
    <div class="container-fluid my-5">
      ...
      // use a for loop to iterate through categories 
        ...
        <div class="card mx-auto" style="width: 18rem;">
          <div class="inner">
          <img src="card'.$id.'.jpeg" class="card-img-top" alt="image for this category">
          </div>
          <div class="card-body">
    ...
    <div class="container-fluid mt-5 p-5 bg-light text-dark bg-light"  style="background-color: #E5E7E9; ">
        ...
        <div class="row">
            <div class="col-lg-6">
            <img src="https://cdn.dnaindia.com/sites/default/files/styles/full/public/2020/12/16/943913-amu.jpg" alt="" class="bd-placeholder-img rounded-circle mx-5" width="140" height="140">
                <h2>Aligarh Muslim University</h2>
                <p>Duis mollis, est non commodo luctus, nisi erat porttitor ligula, eget lacinia odio sem nec elit. Cras
                    mattis consectetur purus sit amet fermentum. Fusce dapibus, tellus ac cursus commodo, tortor mauris
                    condimentum nibh.</p>
                <p><a class="btn btn-secondary" href="https://www.amucontrollerexams.com/" role="button">View details »</a></p>
            </div><!-- /.col-lg-4 -->
            <div class="col-lg-0" >
